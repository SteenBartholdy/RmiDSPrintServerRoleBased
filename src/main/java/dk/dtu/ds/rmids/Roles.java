...
public class Roles 
{
    ...
    public Roles(String role, boolean print, boolean queue, boolean topQueue, boolean start, boolean stop, boolean restart, boolean status, boolean readConfig, boolean setConfig)
    {
        this.role = role;
        this.print = print;
        this.queue = queue;
